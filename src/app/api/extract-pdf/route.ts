...
FORMATO (cada objeto):
{
  ...
  "customsCharges": número (fee de customs/desembaraço calculado sobre o valor da mercadoria quando a cotação expressar como percentual — calcular usando o valor da mercadoria informado no cargo. Ex: "0.5% do valor FOB" com mercadoria EUR 100.000 → 500.00. Zero ou null se não houver este tipo de cobrança percentual) ou null,
